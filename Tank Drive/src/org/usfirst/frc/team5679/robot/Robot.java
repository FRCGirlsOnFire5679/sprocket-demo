...
public class Robot extends IterativeRobot {
	Victor leftMotor0 = new Victor(4);
	Victor leftMotor1 = new Victor(5);
	Victor rightMotor0 = new Victor(2);
	Victor rightMotor1 = new Victor(3);
	Victor victorsBeltLeft = new Victor(0);
	Victor victorsBeltRight = new Victor(1);
...
//		NIVision.IMAQdxStopAcquisition(session);
	...
	public void teleopPeriodic() {
		...
		boolean cameraButton = driveJoystick.getRawButton(1);
